 ...
 * 9.sleep(long millis):让当前线程"睡眠"指定的millis毫秒。在指定的millis毫秒时间内，当前线程是阻塞状态
 ...
 *
 *   说明：高优先级线程要抢占低优先级线程cpu的执行权，但是只是从概率上讲，高优先级的线程高概率情况下被执行
 *   并不意味着只有当高优先级的线程执行完后，低优先级的线程才能执行。
 *
 *
 * @Author: solo.linhan.bai
 * @Create: 2020-08-10 15:20
 */
